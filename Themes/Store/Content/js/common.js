...
//    // 新增分类添加抽屉样式
//    var $pcToggle = $("#aaa,#bbb,#ccc");
//    var $toggleLi = $pcToggle.find("li");
//    $toggleLi.hover(function () {
//        $(this).children('.pc-navigation-linkage').stop(true, false).fadeIn();
//    }, function () {
//        $(this).children('.pc-navigation-linkage').stop(true, false).delay(50).fadeOut();
//    });
});
//product-toggle
//$(function () {
...
$(function () {
    $(".wechat").click(function (e) {
        ...
        if ($(".wechat-picture").length>0) {
            ...
            $(".top-networks")
                .after("<img src='https://cdn.capsulcn.com/Themes/Store/Content/img/wechat.png' class='wechat-picture' alt='wechat' />");
